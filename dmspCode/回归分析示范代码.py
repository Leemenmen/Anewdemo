...
# 导入数据集
income = pd.read_csv(r'D:\Summary\uploadfile\2021-11-16\Salary_Data.csv')
# 绘制散点图
...
# 导入数据
Profit = pd.read_excel(r'D:\Summary\uploadfile\2021-11-16\Predict to Profit.xlsx')
# 将数据集拆分为训练集和测试集
...
# 添加水平参考线
ax2.hlines(y=0, xmin=none_outliers.Marketing_Spend.min(), xmax=none_outliers.Marketing_Spend.max(), color='red',
           linestyles='--')
# 添加x轴和y轴标签
