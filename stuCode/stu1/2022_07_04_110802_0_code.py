...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_0.png')
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_1.png')
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_2.png')

# 条形图的绘制--垂直条形图
# 读入数据
GDP = pd.read_excel(r'F:\project\发布文件\示范数据集\Province_GDP_2017.xlsx')
...
# 显示图形    
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_3.png')
...
# 显示图形    
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_4.png')

# 条形图的绘制--堆叠条形图
# 读入数据
Industry_GDP = pd.read_excel(r'F:\project\发布文件\示范数据集\Industry_GDP.xlsx')
...
plt.legend()
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_5.png')
...
# 读入数据
HuRun = pd.read_excel(r'F:\project\发布文件\示范数据集\HuRun.xlsx')
# 取出城市名称
...
plt.legend()
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_6.png')
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_7.png')
...
plt.ylabel('亿万资产家庭数')
plt.xlabel('')
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_8.png')
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_9.png')

# 读入数据
Titanic = pd.read_csv(r'F:\project\发布文件\示范数据集\titanic_train.csv')
# 绘制水平交错条形图
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_10.png')
...
plt.title('乘客年龄分布')
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_11.png')

# Pandas模块绘制直方图和核密度图
# 绘制直方图
Titanic.Age.plot(kind='hist', bins=20, color='steelblue', edgecolor='black', density=True, stacked=True, label='直方图')
# 绘制核密度图
...
plt.legend()
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_12.png')
...
# 绘制男女乘客年龄的直方图
sns.histplot(Age_Male, bins=20, kde=False, color='steelblue', label='男性')
# 绘制女性年龄的直方图
sns.histplot(Age_Female, bins=20, kde=False, color='purple', label='女性')
plt.title('男女乘客的年龄直方图')
# 显示图例
plt.legend()
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_13.png')

# 绘制男女乘客年龄的核密度图
sns.histplot(Age_Male, color='red', kde=True, line_kws={'lw': 2, 'ls': '-'}, label='男性')
# 绘制女性年龄的核密度图
sns.histplot(Age_Female, color='black',  kde=True, line_kws={'lw': 2, 'ls': '--'}, label='女性')
plt.title('男女乘客的年龄核密度图')
# 显示图例
plt.legend()
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_14.png')
# 读取数据
Sec_Buildings = pd.read_excel(r'F:\project\发布文件\示范数据集\sec_buildings.xlsx')
# 绘制箱线图
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_15.png')
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_16.png')
...
plt.title('不同行政区域的二手房单价对比')
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_17.png')

# 读取数据
tips = pd.read_csv(r'F:\project\发布文件\示范数据集\tips.csv')
# 绘制分组小提琴图
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_18.png')

# 数据读取
wechat = pd.read_excel(r'F:\project\发布文件\示范数据集\wechat.xlsx')
# 绘制单条折线图
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_19.png')
...
plt.legend()
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_20.png')

# 读取天气数据
weather = pd.read_excel(r'F:\project\发布文件\示范数据集\weather.xlsx')
# 统计每月的平均最高气温
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_21.png')

# 读入数据
iris = pd.read_csv(r'F:\project\发布文件\示范数据集\iris.csv')
# 绘制散点图
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_22.png')
...
plt.ylabel('花瓣长度')
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_23.png')
...
sns.lmplot(x='Petal_Width',  # 指定x轴变量
           ...
           hue='Species',  # 指定分组变量
           data=iris,  # 指定绘图数据集
           facet_kws={"legend_out": "False"},  # 将图例呈现在图框内
...
plt.title('鸢尾花的花瓣宽度与长度关系')
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_24.png')
# 读取数据
Prod_Category = pd.read_excel(r'F:\project\发布文件\示范数据集\SuperMarket.xlsx')
...
plt.legend()
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_25.png')

# 读取数据
Sales = pd.read_excel(r'F:\project\发布文件\示范数据集\Sales.xlsx')
# 根据交易日期，衍生出年份和月份字段
...
# 显示图形
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_26.png')

# 读取数据
Prod_Trade = pd.read_excel(r'F:\project\发布文件\示范数据集\Prod_Trade.xlsx')
# 衍生出交易年份和月份字段
...
# 2012年客单价分布直方图
sns.histplot(Prod_Trade.Sales[Prod_Trade.year == 2012], bins=40, ax=ax4,
             color='steelblue', kde_kws=({'linestyle': '--', 'color': 'red'}))
# sns.histplot(Prod_Trade.Sales[Prod_Trade.year == 2012], bins=40, norm_hist=True, ax=ax4,
#              color='steelblue', kde_kws=({'linestyle': '--', 'color': 'red'}))
# 添加标题
...
# 图形显示
plt.savefig('F:/project/Anewdemo/stuCode/stu1/2022_07_04_110802_fig_27.png')