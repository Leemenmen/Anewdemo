# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 21:15:47 2019
...
headers = {
    ...
    'Cookie': 'widget_dz_id=54511; widget_dz_cityValues=,; timeerror=1; defaultCityID=54511; '
              'defaultCityName=%u5317%u4EAC; Hm_lvt_a3f2879f6b3620a363bec646b7a8bcdd=1516245199; '
              'Hm_lpvt_a3f2879f6b3620a363bec646b7a8bcdd=1516245199; addFavorite=clicked',
...
for year in range(2011, 2012):
    for month in range(1, 3):
        if year <= 2016:
            urls.append(
                'http://tianqi.2345.com/t/wea_history/js/58362_%s%s.js' % (year, month))
        else:
            if month < 10:
                urls.append(
                    'https://tianqi.2345.com/t/wea_history/js/%s0%s/58362_%s0%s.js' % (year, month, year, month))
            else:
                urls.append(
                    'http://tianqi.2345.com/t/wea_history/js/%s%s/58362_%s%s.js' % (year, month, year, month))
urls
...
print(weather)
# 数据导出
# weather.to_csv('weather.csv', index=False, encoding='utf_8_sig')
